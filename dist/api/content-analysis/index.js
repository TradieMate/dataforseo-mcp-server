...
function registerContentAnalysisTools(server, apiClient) {
    ...
    (0, tools_js_1.registerTool)(server, "content_analysis_summary", {
        ...
        const response = await apiClient.post("/content_analysis/summary/live", [params]);
        return response;
    }, apiClient);
    // Content Analysis Search
    (0, tools_js_1.registerTool)(server, "content_analysis_search", {
        ...
        const response = await apiClient.post("/content_analysis/search/live", [params]);
        return response;
    }, apiClient);
    // Content Analysis Category
    (0, tools_js_1.registerTool)(server, "content_analysis_category", {
        url: zod_1.z.string().describe("URL to categorize"),
        language_name: zod_1.z.string().optional().describe("Language name"),
        language_code: zod_1.z.string().optional().describe("Language code")
    }, async (params, client) => {
        const response = await apiClient.post("/content_analysis/category/live", [params]);
        return response;
    }, apiClient);
    // Content Analysis Sentiment Analysis
    (0, tools_js_1.registerTool)(server, "content_analysis_sentiment_analysis", {
        text: zod_1.z.string().describe("Text to analyze"),
        language_name: zod_1.z.string().optional().describe("Language name"),
        language_code: zod_1.z.string().optional().describe("Language code")
    }, async (params, client) => {
        const response = await apiClient.post("/content_analysis/sentiment_analysis/live", [params]);
        return response;
    }, apiClient);
    // Content Analysis Rating Distribution
    (0, tools_js_1.registerTool)(server, "content_analysis_rating_distribution", {
        ...
        const response = await apiClient.post("/content_analysis/rating_distribution/live", [params]);
        return response;
    }, apiClient);
}
