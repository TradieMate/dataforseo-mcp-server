...
function registerContentGenerationTools(server, apiClient) {
    ...
    (0, tools_js_1.registerTool)(server, "content_generation_text", {
        ...
        const response = await apiClient.post("/content_generation/text/live", [params]);
        return response;
    }, apiClient);
    // Content Generation Generate Paraphrase
    (0, tools_js_1.registerTool)(server, "content_generation_paraphrase", {
        ...
        const response = await apiClient.post("/content_generation/paraphrase/live", [params]);
        return response;
    }, apiClient);
    // Content Generation Generate Meta Tags
    (0, tools_js_1.registerTool)(server, "content_generation_meta_tags", {
        ...
        const response = await apiClient.post("/content_generation/meta_tags/live", [params]);
        return response;
    }, apiClient);
    // Content Generation Generate Summarize
    (0, tools_js_1.registerTool)(server, "content_generation_summarize", {
        ...
        const response = await apiClient.post("/content_generation/summarize/live", [params]);
        return response;
    }, apiClient);
    // Content Generation Generate Title
    (0, tools_js_1.registerTool)(server, "content_generation_title", {
        ...
        const response = await apiClient.post("/content_generation/title/live", [params]);
        return response;
    }, apiClient);
    // Content Generation Explain Code
    (0, tools_js_1.registerTool)(server, "content_generation_explain_code", {
        ...
        const response = await apiClient.post("/content_generation/explain_code/live", [params]);
        return response;
    }, apiClient);
}
