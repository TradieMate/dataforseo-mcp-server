...
export function registerDomainAnalyticsTools(server: McpServer, apiClient: DataForSeoClient) {
  ...
  registerTool(server, "domain_analytics_technologies_summary", {
  ...
  registerTool(server, "domain_analytics_technologies_domains_by_technology", {
  ...
  registerTool(server, "domain_analytics_technologies_technology_stats", {
