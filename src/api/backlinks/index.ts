...
export function registerBacklinksTools(server: McpServer, apiClient: DataForSeoClient) {
  ...
  // Bulk Backlinks
  registerTool(server, "backlinks_bulk_backlinks", {
  ...
  // Domain Intersection
  registerTool(server, "backlinks_domain_intersection", {
  ...
  // Backlinks Index
  registerTool(server, "backlinks_index", {}, async (_params, client) => {
  ...
  // Backlinks Status
  registerTool(server, "backlinks_errors", {}, async (_params, client) => {
